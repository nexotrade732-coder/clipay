...
import { Eye, EyeOff, Loader2, ArrowLeft, Sparkles, Mail, Lock, User, Link2, Zap, Shield, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen flex" data-testid="auth-page">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-purple-500/10 rounded-full blur-[100px] animate-pulse" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 left-1/2 w-[300px] h-[300px] bg-orange-500/5 rounded-full blur-[80px] animate-pulse" style={{animationDelay: '2s'}}></div>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          >
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 via-purple-500 to-orange-500 rounded-[28px] opacity-20 blur-lg animate-gradient"></div>
            ...
            <div className="glass rounded-3xl p-8 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="relative group">
                          <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-xl opacity-0 group-focus-within:opacity-100 blur transition-opacity"></div>
                ...
                >
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-xl opacity-0 group-focus-within:opacity-100 blur transition-opacity"></div>
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 mt-8 rounded-xl font-semibold text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 relative overflow-hidden group"
                  style={{
                    background: isLogin 
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600/30 via-purple-600/20 to-orange-600/30 animate-gradient"></div>
        <div className="absolute inset-0 grid-bg opacity-30"></div>
        
        {/* Floating orbs */}
        <div className="absolute top-20 left-20 w-32 h-32 bg-blue-500/30 rounded-full blur-2xl animate-float"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-purple-500/30 rounded-full blur-2xl animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 right-1/4 w-24 h-24 bg-orange-500/30 rounded-full blur-2xl animate-float" style={{animationDelay: '2s'}}></div>
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="space-y-6">
            ...
            >
              <div className="w-14 h-14 rounded-xl icon-box-blue flex items-center justify-center flex-shrink-0">
            ...
            <motion.div
              ...
              className="glass rounded-2xl p-5 flex items-center gap-4 card-hover"
            >
              <div className="w-14 h-14 rounded-xl icon-box-purple flex items-center justify-center flex-shrink-0">
